...
export const GRAPHQL_QUERY = 'graphql:query';
export const GRAPHQL_MUTATION = 'graphql:mutation';
export const GRAPHQL_SUBSCRIPTION = 'graphql:subscription';
export const GRAPHQL_TYPE = 'graphql:type';
